...
class TestCaseIncar1:
    ...
    def impl_incar_1(self):
        ...
        for radius in range(1, 6):
            func_def_obj.cheers_cal_inc_1(radius, self.intermediate_calculation_precision,
                                          self.output_calculation_precision)
